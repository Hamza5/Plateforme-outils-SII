...
de la bibliothèque. Le panneau \textit{Décision} contient un bouton pour exécuter l'application \textbf{DecPos}
qui permet d'effectuer des calculs sur la décision et des opérations sur les bases possibilistes.
...
notre application \appname qui a été expliquée auparavant.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Incertain_DS}
