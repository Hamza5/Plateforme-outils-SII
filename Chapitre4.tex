...
à décrir la grande boîte à outils qui regroupe plusieurs programmes reliés aux théories de
l'incertain. Nous allons aussi expliquer comment cet boîte intéragit avec ces programmes.
...
interface avec \textbf{Java Swing}. En plus, il y a plusieurs scriptes utilisés par cette
interface sont écrits en \textbf{MATLAB}. D'autres outils sont programmés en language
...
et un emplacement pour le fichier. Il aura par défaut l'extention \texttt{.dsti.xml}. Si on ignore cette étape le programme
