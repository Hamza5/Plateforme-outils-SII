...
% Pour la 1ère page
\title{Conception et réalisation d'une interface integrant differentes toolboxes autour des theories de l'incertaines}
...
\newcommand{\appname}{\textbf{combinateur d'évidences} }
\newcommand{\appName}{Combinateur d'évidences }
% Nom de la grande interface
\newcommand{\platformename}{\textbf{plateforme d'outils} }
\newcommand{\platformeName}{Plateforme d'outils }
