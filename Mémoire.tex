...
\usepackage{xspace} % Les espaces après une commande
...
\newcommand{\platformename}{\textbf{plateforme d'outils}\xspace}
\newcommand{\platformeName}{Plateforme d'outils\xspace}
