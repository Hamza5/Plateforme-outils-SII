...
\newcommand{\appname}{\textbf{fusionneur de croyances} }
\newcommand{\appName}{Fusionneur de croyances }
% Nom de la grande interface
\newcommand{\platformename}{\textbf{platforme d'outils} }
\newcommand{\platformeName}{Platforme d'outils }
\begin{document}
\maketitle
\tableofcontents
\include{Chapitre1}
