...
$\textit{EtatsDuMonde}$ est une variable utilisée dans l'algorithme qui représente les états du monde collectés à cette étape  \\
\begin{algorithm}[H]
...
Grâce à cet algorithme, nous pouvons appeler les méthodes de combinaison en passant les agents deux par deux en paramètres, de ce fait on peut fusionner un nombre de deux connaissances d'agents ou plus .\\
...
\BlankLine
\KwIn{
$AGENT1 = \lbrace \lbrace hypothèse_{1},masse_{1} \rbrace  \dots \lbrace hypothèse_{n},masse_{n} \rbrace \rbrace $,$\newline AGENT2 = \lbrace \lbrace hypothèse_{1},masse_{1} \rbrace  \dots \lbrace hypothèse_{m},masse_{m} \rbrace \rbrace $}
\KwOut{$AGRes = \lbrace \lbrace hypothèse_{1},masse_{1} \rbrace  \dots \lbrace hypothèse_{l},masse_{l} \rbrace \rbrace $}
\BlankLine 
\Begin
