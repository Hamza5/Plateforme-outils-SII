...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDempster_Shafer.setStatusTip(_fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.etatsGroupBox.setToolTip(_translate("MainWindow", "Les hypothèses singletons", None))
        self.etatsGroupBox.setTitle(_translate("MainWindow", "Etats du monde", None))
        self.hypothesesGroupBox.setToolTip(_translate("MainWindow", "Les combinaisons des états du monde", None))
        self.hypothesesGroupBox.setTitle(_translate("MainWindow", "Hypothèses", None))
        self.AgentsGroupBox.setToolTip(_translate("MainWindow", "Les sources", None))
        ...
        self.menuM_thode_de_d_cision.setStatusTip(_translate("MainWindow", "Choisir la méthode utilisée pour la décision", None))
        self.menuM_thode_de_d_cision.setTitle(_translate("MainWindow", "&Méthode de décision", None))
        self.menuM_thode_de_calcule.setStatusTip(_translate("MainWindow", "Choisir la méthode utilisée pour la combinaison des informations", None))
        ...
        self.actionTitre.setStatusTip(_translate("MainWindow", "Donner un titre au projet", None))
        ...
        self.actionDescription.setStatusTip(_translate("MainWindow", "Donner une description au projet", None))
        ...
        self.actionAjouterEtat.setStatusTip(_translate("MainWindow", "Ajouter une hypothèse élémentaire", None))
        ...
        self.actionSupprimerEtat.setStatusTip(_translate("MainWindow", "Supprimer une hypothèse élémentaire", None))
        ...
        self.actionAjouterHypothese.setStatusTip(_translate("MainWindow", "Ajouter une hypothèse", None))
        ...
        self.actionSupprimerHypothese.setStatusTip(_translate("MainWindow", "Supprimer une hypothèse", None))
        ...
        self.actionAjouterAgent.setStatusTip(_translate("MainWindow", "Ajouter un expert", None))
        ...
        self.actionSupprimerAgent.setStatusTip(_translate("MainWindow", "Supprimer un expert", None))
        ...
        self.actionModifierAgent.setStatusTip(_translate("MainWindow", "Modifier les paramètres d\'un expert", None))
        ...
        self.actionNouveau.setStatusTip(_translate("MainWindow", "Effacer tout et commencer un nouveau projet", None))
        ...
        self.actionCalculer.setStatusTip(_translate("MainWindow", "Lancer le programme de calcul et afficher les résultats", None))
        ...
        self.actionOuvrir_des_resultats.setStatusTip(_translate("MainWindow", "Ouvrir les résultats d\'un calcul", None))
        self.actionOuvrir_des_resultats.setShortcut(_translate("MainWindow", "Ctrl+R", None))
