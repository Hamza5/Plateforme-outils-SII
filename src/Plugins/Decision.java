...
public class Decision extends JPanel {
    ...
    public Decision(){
        ...
        JButton DecPosButton = new JButton(new AbstractAction(DecPosButtonText) {
             public void actionPerformed(ActionEvent actionEvent) {
                try {
                    final URL decPosURL = ClassLoader.getSystemClassLoader().getResource("Plugins/Decision/DecPos");
        ...
        JButton Khaoula = new JButton(new AbstractAction(FuzzyButtonText) {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    Runnable externalProgramLauncher = new Runnable() {
                    	...
                    	Path path = Paths.get(System.getProperty("user.dir"),"src","Plugins","Decision","Pnt");	
